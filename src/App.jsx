      ...
      <div className="relative w-full max-w-5xl bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-white/40 p-8">
        ...
        <div className="p-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            {/* Total Subjects */}
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 shadow-sm hover:shadow-xl transition-transform duration-300 hover:scale-[1.1]">
            ...
            {/* Average */}
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-transform duration-300 hover:scale-[1.1]">
            ...
            {/* Highest */}
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-transform duration-300 hover:scale-[1.1]">
            ...
            {/* Lowest */}
            <div className="bg-red-50 border border-red-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-transform duration-300 hover:scale-[1.1]">
